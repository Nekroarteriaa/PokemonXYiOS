...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PokemonXYiOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12PokemonXYiOS11AppDelegate")
...
SWIFT_CLASS("_TtC12PokemonXYiOS25EvolvesBaseViewController")
@interface EvolvesBaseViewController : UIViewController
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified PokemonGifCollectionView;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC12PokemonXYiOS26EeveeEvolvesViewController")
@interface EeveeEvolvesViewController : EvolvesBaseViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
- (void)viewDidLoad;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (UIEdgeInsets)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout insetForSectionAtIndex:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC12PokemonXYiOS26ForthEvolvesViewController")
@interface ForthEvolvesViewController : EvolvesBaseViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
@property (nonatomic, weak) IBOutlet UICollectionView * _Null_unspecified PokemonGifCollectionVerticalView;
- (void)viewDidLoad;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC12PokemonXYiOS34PokemonEvolutionCollectionViewCell")
@interface PokemonEvolutionCollectionViewCell : UICollectionViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified PokemonGifHolderImageVIew;
...
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified PokemonImage;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified NameLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified IDLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified MainTypeLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified SecondTypeLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified MainTypeImage;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified SecondTypeImage;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC12PokemonXYiOS13SceneDelegate")
...
SWIFT_CLASS("_TtC12PokemonXYiOS14ViewController")
